...
export const constantRouterMap = [
  ...
  },
  {
    ...
    name: 'setting',
    meta: {title: '基础设置', icon: 'product'},
    children: [{
      path: 'company',
      name: 'company',
      component: () => import('@/views/setting/company/index'),
      meta: {title: '单位设置', icon: 'product-list'}
    ...
    },
    {
      ...
      meta: {title: '地点设置', icon: 'product-add'}
    },
    {
      path: 'address/update',
      name: 'addressUpdate',
	...
	},
    {
      ...
      meta: {title: '线路设置', icon: 'product-add'}
    },
    {
      path: 'line/add',
      name: 'lineAdd',
	...
	},
	{
	  ...
	  meta: {title: '线路地点设置', icon: 'product-list'},
	  hidden: true
	},
	{
	...
	},
	{
	  ...
	  meta: {title: '人员设置', icon: 'product-add'}
	},
	{
	  path: 'staff/update',
	  name: 'staffUpdate',
	...
	},
	{
	  ...
	  meta: {title: '事件设置', icon: 'product-add'}
	},
	{
	...
	},
	{
	  ...
	  meta: {title: '设备号设置', icon: 'product-add'}
	},
	{
	...
	},
	{
	  ...
	  meta: {title: '添加关联事件', icon: 'product-list'},
	  hidden: true
	},
	{
	  path: 'PlanSetUp',
	  ...
	  meta: {title: '计划设置', icon: 'product-add'}
	},
	{
	  path: 'PlanSetUp/add',
	  name: 'PlanSetUpAdd',
	...
	},
	{
	  ...
	  meta: {title: '计划点设置', icon: 'product-list'},
	  hidden: true
	},
	{
	...
	},
	{
	  ...
	  meta: {title: '计划关联设备', icon: 'product-list'},
	  hidden: true
	},
	{
	...
	},
	{
	  ...
	  meta: {title: '计划关联巡检员设置', icon: 'product-list'},
	  hidden: true
	},
	{
  ...
  },
  {
    ...
    children: [{
      ...
      meta: {title: '发布通知', icon: 'product-list'}
    },{
      path: 'publish/add',
      name: 'publishAdd',
  ...
  },
  {
    ...
    children: [{
      ...
      meta: {title: '联系人管理', icon: 'product-list'}
    },{
      path: 'add',
      name: 'ContactAdd',
