...
export const constantRouterMap = [
  ...
  },
  {
    ...
    name: 'setting',
    meta: {title: '基础设置', icon: 'product-list'},
    children: [{
      path: 'company',
      name: 'company',
    ...
    },
    {
      ...
      meta: {title: '地点设置', icon: 'product-list'}
    },
    {
      path: 'address/update',
      name: 'addressUpdate',
	...
	},
    {
      ...
      meta: {title: '线路设置', icon: 'product-list'}
    },
    {
      path: 'line/add',
      name: 'lineAdd',
	...
	},
	{
	  ...
	  meta: {title: '人员设置', icon: 'product-list'}
	},
	{
	  path: 'staff/update',
	  name: 'staffUpdate',
	...
	},
	{
	  ...
	  meta: {title: '事件设置', icon: 'product-list'}
	},
	{
	...
	},
	{
	  ...
	  meta: {title: '设备号设置', icon: 'product-list'}
	},
	{
	...
	},
	{
	  ...
	  meta: {title: '计划设置', icon: 'product-list'}
	},
	{
	  path: 'PlanSetUp/add',
	  name: 'PlanSetUpAdd',
  ...
  },
  {
    ...
    name: 'data',
    meta: {title: '报表数据', icon: 'product-list'},
    children: [{
    ...
    name: 'inform',
    meta: {title: '通知管理', icon: 'product-list'},
    children: [{
      path: 'inquire',
      name: 'inquire',
