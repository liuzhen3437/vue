...
<!-- 			    <el-date-picker
			...
			<el-form-item label="单圈重复次数：" v-show="line.type===0" prop="lineRepeatTimes">
				...
				<div class="inw200">
					<!-- <el-input v-model="line.lineRepeatTimes"  :disabled="planinfo.lineRepeatTimesButton===1"  @blur="lineRepeatTimesBlur" oninput="value=value.replace(/^\.+|[^\d.]/g,'')"></el-input> -->
